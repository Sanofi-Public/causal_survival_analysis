...
```{r}
ggsave(
  filename = "figures/fig-15-rct1.pdf",  # nom du fichier
...
```{r}
ggsave(
  filename = "figures/fig-16-rct1.pdf",  # nom du fichier
...
```{r}
ggsave(
  filename = "figures/fig-17-obs1.pdf",  # nom du fichier
...
```{r}
ggsave(
  filename = "figures/fig-18-obs2.pdf",  # nom du fichier
...
```{r}
ggsave(
  filename = "figures/fig-19-mis.pdf",  # nom du fichier
  plot = simulation_graph_mis,            # objet graphique
  device = "pdf",                          # format
  width = 12, height = 8,                  # dimensions en pouces
  units = "in"                             # unités (ici, pouces)
)
...
simulation_graph_mis2 <- simulation_mis2 %>%
  ...
  theme(legend.title = element_blank(), legend.position = "bottom",
    ...
    axis.text.x = element_text(size = 15, angle = 37, vjust = 1, hjust = 1),  
    # Adjust text angle for better visibility
    axis.text = element_text(size = 15, face = "bold"),
    axis.title.x = element_text(size = 18, face = "bold"),
    axis.title.y = element_text(size = 13, face = "bold"),
    axis.text.y = element_text(size = 15, face = "bold"),  # Taille augmentée ici
    plot.margin = margin(t = 10, r = 10, b = 50, l = 10)  # Add margin
  ) +    
  coord_cartesian(ylim = c(0.1, 0.4))
...
#| warning: false
simulation_graph_mis2 <- grid.arrange(simulation_graph_mis2, simulation_graph_mis_miscens, simulation_graph_mis_misout, simulation_graph_mis_mistreat, ncol = 2, nrow = 2)
```

```{r}
ggsave(
  filename = "figures/fig-20-mis2.pdf",  # nom du fichier
  plot = simulation_graph_mis2,            # objet graphique
  device = "pdf",                          # format
  width = 13, height = 17,                # dimensions en pouces
  units = "in"                             # unités (ici, pouces)
)
```
...
#| warning: false
simulation_graph_mis3 <- grid.arrange(simulation_graph_mis_mistreat_out, simulation_graph_mis_miscens_out, simulation_graph_mis_mistreat_cens, simulation_graph_mis_all, ncol = 2, nrow = 2)
```


```{r}
ggsave(
  filename = "figures/fig-21-mis3.pdf",  # nom du fichier
